...
# set cup model
# var cup = preload("res://models/cup.glb")
...
const anchors: Dictionary = {0: Vector3(0,0,0), 1: Vector3(0,0,0), 2: Vector3(0,0,0), 3: Vector3(0,0,0)}
const dice_per = 5
...
func _create_dice(values: Array, target: int) -> void:
	for i in dice_per:
